...
<?php $__env->startSection('charts'); ?>
    ...
    <script>
        ...
        var url3 = "<?php echo e(url('/totalsalesperemployee')); ?>";
        ...
        var url2 = "<?php echo e(url('/totalsalesperday')); ?>";
        ...
        var url = "<?php echo e(url('/totalsalesperservice')); ?>";
        var sales = new Array();
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\Metrobarbers\resources\views/sidebar/charts.blade.php ENDPATH**/ ?>