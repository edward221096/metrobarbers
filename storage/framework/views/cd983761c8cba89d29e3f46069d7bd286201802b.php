                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" name="name" placeholder="Full Name"
                               required autocomplete="name" value="<?php echo e($users->name); ?>">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="email">E-mail Address</label>
                        <input type="text" class="form-control form-control-sm" name="email" placeholder="E-mail Address"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="number" class="form-control form-control-sm" name="phonenumber" placeholder="Phone Number"
...
<?php /**PATH C:\laravel\Metrobarbers\resources\views/sidebar/editemployees.blade.php ENDPATH**/ ?>